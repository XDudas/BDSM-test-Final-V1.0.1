...
function answerQuestion(isYes) {
    ...
    if (isYes) {
        ...
        responseText.textContent = "Tu és gay vai passear para Setubal, é por este tipo de merdas que teu pai foi para cabo verde ás salinas boiar enquanto fuma um cigarro e cagou na boca da tua família!";
    }
}
